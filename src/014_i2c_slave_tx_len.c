...
uint8_t TxBuffer[] = "...123";
uint32_t data_len  = 0;
...
void I2C_ApplicationEventCallback(I2C_Handle_t *pI2CHandle, uint8_t AppEv)
{
    ...
    if(AppEv == I2C_EVNT_DATA_REQ)
    {
        ...
        if(cmdCode == 0x51)
        {
            // Send the length information to the master, sending 4 bytes of length information
            I2C_SlaveSendData(pI2CHandle->pI2Cx, (data_len >> ((data_index % 4) * 8)) & 0xFF);
		    data_index++;
        }
        else if(cmdCode == 0x52)
        {
            // Send the contents of TxBuffer indexed by w_ptr variable
            I2C_SlaveSendData(pI2CHandle->pI2Cx, TxBuffer[w_ptr++]);
    ...
    {
        // Master has sent NACK. Slave concludes it sent all the bytes.
        printf("NACK received from master\n");
        
        // if the current active code is 0x52 then dont invalidate
        if(!(cmdCode == 0x52))
            cmdCode = 0xFF; // invalidate the cmd code
        
        data_index = 0; // reset the data index because end of transmission
